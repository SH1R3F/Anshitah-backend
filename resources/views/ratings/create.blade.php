                    ...
                    <div class="card-body p-0">
                        <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                <!--begin: Wizard Form-->
                                <form class="form mt-0 mt-lg-10 fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="post" action="{{ route('ratings.store') }}">
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="q8" placeholder="أدخل إجابتك" value
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="q9" placeholder="أدخل إجابتك" value
                                                        class="form-control form-control-solid form-control-lg" required />
                                                    <div class="fv-plugins-message-container"></div>
                                                </div>
                                            </div><!-- فرص التحسين -->
                                    ...
                                    <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                        ...
                                        <div>
                                            <button type="button"
                                                ...
                                                data-wizard-type="action-submit">إنشاء زيارة</button>
                                            <button type="button"
        ...
        var KTEcommerceCheckout = function() {
            ...
            var _initWizard = function() {
                ...
                _wizardObj.on('submit', function(wizard) {
                    Swal.fire({
                        text: "كل شيء سليم تريد إنشاء الزيارة",
                        icon: "success",
                        showCancelButton: true,
                        buttonsStyling: false,
                        confirmButtonText: "نعم قم بإنشاء الزيارة!",
