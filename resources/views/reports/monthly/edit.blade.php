                        ...
                        <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                            <div class="wizard-wrapper">
                                ...
                                <div class="wizard-label">
                                    <div class="wizard-title">تعديل تقرير شهري :</div>
                    ...
                    <div class="card-body p-0">
                        <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                <form class="form mt-0 mt-lg-10 fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="post" action="{{ route('reports.monthly.update' , ['id' => $report->id]) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>
                                                        عدد الأنشطة المنفذة خارج المدارس</label>
                                                    <input type="number"
                                                    value="{{ $report->q1 }}"
                                                    class="form-control form-control-solid form-control-lg"
                                    ...
                                    <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                        ...
                                        <div>
                                            <button type="button"
                                                ...
                                                data-wizard-type="action-submit">تعديل التقرير</button>
                                            <button type="button"
