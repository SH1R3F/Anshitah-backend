            ...
            <div class="card" id="kt_chat_messenger">
                                ...
                                <div class="d-flex justify-content-end mb-10">
                                    ...
                                    <div class="d-flex flex-column align-items-end">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <!--begin::Details-->
                                            <div class="mx-3">
                                                <a class="fs-5 fw-bolder text-gray-900 text-hover-secondary me-1">الدعم الفني</a>
                                            </div>
                                            <!--end::Details-->
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('assets/media/1025056.png') }}">
                                            </div>
                                            <!--end::Avatar-->
                                        </div>
                                        <!--end::User-->
                ...
                @if ($ticket->status == 1)
                    ...
                    <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                        <form action="{{ route('technical-support.message', ['id' => $ticket->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Input-->
