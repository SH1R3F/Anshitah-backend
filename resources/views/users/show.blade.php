...
<div class="card card-custom card-stretch">
    <div class="card-header py-3">
        <div class="card-toolbar">
            <a href="{{ route('users.edit',['id' => $user->id]) }}" class="btn btn-success mr-2">تعديل</a>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <a href="{{ $user->milaf_howiya }}" target="_blank" class="badge badge-primary d-block mx-auto">ملف
                            الهوية</a>
                        @else
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <a href="{{ $user->milaf_wadifi }}" target="_blank" class="badge badge-info d-block mx-auto">الملف
                            الوظيفي</a>
                        @else
                        <div class="badge badge-warning text-white d-block mx-auto">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input name="university" readonly class="form-control form-control-lg form-control-solid"
                            type="text" value="{{ $user->university }}">
                    </div>
                </div><!-- الجامعة -->
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input readonly class="form-control form-control-lg form-control-solid"
                            type="text" value="{{ $user->date_birth }}">
                    </div>
                </div><!-- تاريخ الميلاد -->
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input readonly class="form-control form-control-lg form-control-solid"
                            type="text" value="{{ $user->date_graduation }}">
                    </div>
                </div><!-- تاريخ التخرج -->
                <div class="form-group row">
