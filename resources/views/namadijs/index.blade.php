...
@section('action')
<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#create-trainingplan">إضافة نموذج</button>
@endsection
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    {{-- @can('حذف خطة تدريب') --}}
                                    <form action="{{ route('delete.namadijs', [ 'id' => $khota->id ]) }}" method="post">
                                        @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">تعديل النموذج</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <form action="{{ route('update.namadijs') }}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="create-trainingplan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('create.namadijs') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label>النموذج</label>
