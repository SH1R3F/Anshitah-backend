                    ...
                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form class="form mt-0 mt-lg-10 fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                                method="post" action="{{ route('plans.update',['id'=>$plan->id]) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="date_start"
                                                        ...
                                                        placeholder="أدخل إجابتك" value="{{ $plan->date_start }}"
                                                        required />
                                                </div>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="date_end"
                                                        class="form-control hijri-date-default form-control-solid form-control-lg"
                                                        placeholder="أدخل إجابتك" value="{{ $plan->date_end }}"
                                                        required />
                                                </div>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="kt-tinymce" name="adaa_madariss" cols="30" rows="10">
                                                    {!! $plan->adaa_madariss !!}
                                                </textarea>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="kt-tinymce" name="nokat_qiass" cols="30" rows="10">
                                                    {!! $plan->nokat_qiass !!}
                                                </textarea>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="kt-tinymce" name="ijraat" cols="30" rows="10">
                                                    {!! $plan->ijraat !!}
                                                </textarea>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="kt-tinymce" name="amakin_tanfid" cols="30" rows="10">
                                                    {!! $plan->amakin_tanfid !!}
                                                </textarea>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="kt-tinymce" name="asalib_tanfid" cols="30" rows="10">
                                                    {!! $plan->asalib_tanfid !!}
                                                </textarea>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="file">إختر ملف</label>
                                                </div>
                                            </div>
                                        </div><!-- ملف -->
                                    </div>
                                ...
                                <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                    ...
                                    <div>
                                        <button type="button"
                                            ...
                                            data-wizard-type="action-submit">تعديل الخطة</button>
                                        <button type="button"
        ...
        var KTEcommerceCheckout = function() {
            ...
            var _initWizard = function() {
                ...
                _wizardObj.on('submit', function(wizard) {
                    Swal.fire({
                        text: "كل شيء سليم تريد تعديل الخطة",
                        icon: "success",
                        showCancelButton: true,
                        buttonsStyling: false,
                        confirmButtonText: "نعم قم بتعديل الخطة",
