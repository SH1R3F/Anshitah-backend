...
<div class="card card-custom">
 ...
 تعديل نشاط طلابي
    ...
    <!--begin::Form-->
    <form method="post" action="{{ route('tolabnashats.update' , ['id' => $data->id]) }}">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input name="work" type="text" class="form-control" value="{{ $data->work }}" placeholder="عمله باللجنة" />
                {{-- <span class="form-text text-muted">We'll never share your email with anyone else.</span> --}}
            </div>
            <div class="form-group">
                <label>الملاحظات<span class="text-danger">*</span></label>
                <input name="note" type="text" class="form-control" value="{{ $data->note }}" placeholder="الملاحظات" />
                {{-- <span class="form-text text-muted">We'll never share your email with anyone else.</span> --}}
            </div>
        </div>
