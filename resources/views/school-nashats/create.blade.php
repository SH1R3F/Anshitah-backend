...
<div class="card card-custom">
 ...
 إنشاء نشاط مدرسي
    ...
    <!--begin::Form-->
    <form method="post" action="{{ route('schoolnashats.store') }}">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input name="work" type="text" class="form-control" placeholder="عمله بالمجلس" />
                {{-- <span class="form-text text-muted">We'll never share your email with anyone else.</span> --}}
            </div>
            <div class="form-group">
                <label>العمل المسند إليه<span class="text-danger">*</span></label>
                <input name="task" type="text" class="form-control" placeholder="العمل المسند إليه" />
                {{-- <span class="form-text text-muted">We'll never share your email with anyone else.</span> --}}
            </div>
        </div>
