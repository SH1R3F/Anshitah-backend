            ...
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        ...
                        <!--begin::Form-->
                        <form method="post" action="{{ route('donate-teacher-post') }}" enctype="multipart/form-data">
                            @csrf
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg"> وقت التطوع - مشروع المدرسة</h3>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                                @enderror""
                                    type=" text" placeholder="اسم رائد النشاط" name="name" autocomplete="off" />
                                @error('name')
